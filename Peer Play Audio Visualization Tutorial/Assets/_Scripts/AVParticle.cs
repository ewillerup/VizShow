...
public class AVParticle : MonoBehaviour
{
    ...
    void Update()
    {
        _main.startColor = new Color(_main.startColor.color.r, _main.startColor.color.g, _main.startColor.color.b, (AudioPeer._audioBandBuffer[_band - 1] * (_maxAlpha - _minAlpha)) + _minAlpha);
    }
}
